...
public class MutiSignDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            com.github.DNAProject.account.Account[] accounts = new com.github.DNAProject.account.Account[]{acct1,acct2,acct3};
            int M = 2;
            ...
            dnaSdk.addMultiSign(tx,M,pks,acct1);
            ...
            tx.sigs = null;
            dnaSdk.addMultiSign(tx,M,pks,acct2);
            ...
            tx.sigs = null;
            dnaSdk.addMultiSign(tx,M,pks,acct3);
            ...
            tx.sigs = null;
            dnaSdk.addMultiSign(tx,M,pks,tx1.sigs[0].sigData[0]);
            dnaSdk.addMultiSign(tx,M,pks,tx2.sigs[0].sigData[0]);
            dnaSdk.addMultiSign(tx,M,pks,tx3.sigs[0].sigData[0]);
