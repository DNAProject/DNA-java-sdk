...
//    	BigInteger[] bi = signer.generateSignature(Digest.sha256(getHashData()));	// antshars
    	BigInteger[] bi = signer.generateSignature(Digest.sha256(Digest.sha256(getHashData())));// dna
