    ...
    public static void main(String[] args) {
        try {
            ...
            if(true){
                ...
                Object res = dnaSdk.neovm().sendTransaction(Helper.reverse("dedc8c61d03dcc3387737fbddbe8096300be84de"),acct,acct,
...
//            Account account7s = getAccount("ZG/SfHRArUkopwhQS1MW+a0fvQvyN1NnwonU0oZH8y1bGqo5T+dQz3rz1qsXqFI2","1","AQNpGWz4oHHFBejtBbakeR43DHfen7cm8L","6qiU9bgK/+1T2V8l14mszg==");
            ...
            if(false){
                ...
                if (preExec){
                    Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse(youleAddress),null,null,20000,0,func, preExec);
                    System.out.println(obj);
                }else {
                    Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse(quanjiaAddress),adminAcct,adminAcct,20000,0,func, preExec);
                    System.out.println(obj);
                    Thread.sleep(6000);
                    System.out.println(dnaSdk.getConnect().getSmartCodeEvent((String) obj));
                }
                return;
            }
            ...
            if (false){
                ...
                Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse(quanjiaAddress),null,null,20000,0,func, preExec);
                System.out.println(obj);
                return;
            }
            //
            ...
            if (false){
                ...
                AbiFunction func = abiinfo.getFunction(name);
                boolean preExec = true;
                Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse(swapAddress2),null,null,20000,0,func, preExec);
                System.out.println(obj);
                return;
            }
            Account adminAcct = new Account(Helper.hexToBytes("75de8489fcb2dcaf2ef3cd607feffde18789de7da129b5e97c81e001793cb7cf"),SignatureScheme.SHA256WITHECDSA);
            ...
            if (false){
                ...
                boolean preExec = false;
                Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse(swapAddress2),adminAcct,adminAcct,20000,0,func, preExec);
                System.out.println(obj);
                Thread.sleep(6000);
                System.out.println(dnaSdk.getConnect().getSmartCodeEvent((String)obj));
                return;
            ...
            if(false){
                com.github.DNAProject.sdk.wallet.Account account9999999 = dnaSdk.getWalletMgr().importAccount("8p2q0vLRqyfKmFHhnjUYVWOm12kPm78JWqzkTOi9rrFMBz624KjhHQJpyPmiSSOa","111111","AHX1wzvdw9Yipk7E9MuLY4GGX4Ym9tHeDe",Base64.getDecoder().decode("KbiCUr53CZUfKG1M3Gojjw=="));
                Account account = dnaSdk.getWalletMgr().getAccount(account9999999.address, "111111", account9999999.getSalt());
                dnaSdk.nativevm().gas().sendTransfer(account,account3.getAddressU160().toBase58(),100000,account,200000,0);
                System.out.println(dnaSdk.getConnect().getBalance(account9999999.address));
                ...
                dnaSdk.nativevm().gas().withdrawGas(account,account.getAddressU160().toBase58(),359943000000L,account,200000,0);
                return;
            }
            ...
            if (true){
                ...
                boolean preExec = false;
                Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse(swapAddress2),adminAcct,adminAcct,20474,0,func, preExec);
                System.out.println(obj);
                Thread.sleep(6000);
                System.out.println(dnaSdk.getConnect().getSmartCodeEvent((String)obj));
                return;
            ...
            if(true){
                ...
                boolean preExec = false;
                Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse("df57f2c82646b96ce2ae68dba27460958b46abf7"),youleAcct,adminAcct,20000,500,func, preExec);
                System.out.println(obj);
                Thread.sleep(6000);
                System.out.println(dnaSdk.getConnect().getSmartCodeEvent((String) obj));
                return;
            ...
            if(false){
                com.github.DNAProject.sdk.wallet.Account adminAcc = dnaSdk.getWalletMgr().importAccount("bBkseVtWdArWNc2OfVnNONt+FV+6RRgvle2ffxYNrOU3bzGzq3dG07PXkzlunfi2","xinhao","AQf4Mzu1YJrhz9f3aRkkwSm9n3qhXGSh4p",Base64.getDecoder().decode("1NF1DK9zgDyB2cAcSRfB6w=="));
                //有乐管理员Account
                Account youleadminAcct = dnaSdk.getWalletMgr().getAccount("AQf4Mzu1YJrhz9f3aRkkwSm9n3qhXGSh4p","xinhao");
                com.github.DNAProject.sdk.wallet.Account quanjiaadminAcc = dnaSdk.getWalletMgr().importAccount("zJ2+ScaXH04G7zHh9QatqJTx4aZS1ehJ4TQlPAJ6n4qZZfzV6iWfC0novEzNwzil","xinhao","ANTPeXCffDZCaCXxY9u2UdssB2EYpP4BMh",Base64.getDecoder().decode("nAb1JNde0mC2PDYs9knxcQ=="));
                //全家管理员Account
                Account quanjiaadminAcct = dnaSdk.getWalletMgr().getAccount("AQf4Mzu1YJrhz9f3aRkkwSm9n3qhXGSh4p","xinhao");
                ...
                boolean preExec = false;
                if (preExec){
                    Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse("fb2ce5bd31bfb50662d95aaef1badcb8f8b71ce1"),null,null,20000,0,func, preExec);
                    System.out.println(obj);
                }else {
                    Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse("44f1f4ee6940b4f162d857411842f2d533892084"),quanjiaadminAcct,quanjiaadminAcct,20000,0,func, preExec);
            ...
            if(false){
                ...
                boolean preExec = true;
                if (preExec){
                    Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse("d755c02caf5741b1c3352a06a41271716a1fca78"),null,null,20000,0,func, preExec);
                    System.out.println(obj);
                }else {
                    Object obj =  dnaSdk.neovm().sendTransaction(Helper.reverse("fb2ce5bd31bfb50662d95aaef1badcb8f8b71ce1"),quanjiaadminAcct,quanjiaadminAcct,20000,0,func, preExec);
            ...
            if(false){
                ...
                dnaSdk.neovm().sendTransaction(Helper.reverse("44f1f4ee6940b4f162d857411842f2d533892084"),acct,acct,20000,500,func,false);
//
//                Transaction tx = dnaSdk.vm().makeInvokeCodeTransaction(Helper.reverse("44f1f4ee6940b4f162d857411842f2d533892084"),null,params,account3.getAddressU160().toBase58(),20000,0);
//                dnaSdk.signTx(tx,new Account[][]{{account999}});
//                dnaSdk.addSign(tx,account3);
...
//                System.out.println(dnaSdk.getConnect().getSmartCodeEvent(tx.hash().toHexString()));
            ...
            if(transferMulti){
                ...
                Transaction tx = dnaSdk.vm().makeInvokeCodeTransaction(Helper.reverse("ad0bd8c715fcec8d7b3bed0fd1c88fcc8ef43927"),null,params,account.getAddressU160().toBase58(),20000,0);
                dnaSdk.signTx(tx,new Account[][]{{account}});
                dnaSdk.addSign(tx,adminAcct);
                dnaSdk.getConnect().sendRawTransaction(tx);
