...
public class ECIES {
    ...
    public static String[] Encrypt(String pubkey, byte[] msg, int keylen) throws Exception{
        try {
            com.github.DNAProject.account.Account account = new com.github.DNAProject.account.Account(false, Helper.hexToBytes(pubkey));
    ...
    public static byte[] Decrypt(byte[] prikey, byte[] IV, byte[] key_cxt, byte[] ciphertext, int keylen) throws Exception {
        try {
            com.github.DNAProject.account.Account account = new com.github.DNAProject.account.Account(prikey, signatureScheme);
